...
function VerifyForgotPasswordContent() {
    ...
    return (
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
            <div
                className="w-full md:w-1/2 min-h-100 md:min-h-162.5 bg-cover bg-center flex items-center justify-center p-10 md:p-16 text-white"
                style={{ backgroundImage: "linear-gradient(rgba(1,4,39,0.72), rgba(1,4,39,0.72)), url('/images/login/bg1.webp')" }}
            >
                <div className="flex flex-col items-center text-center max-w-sm">
                    <Image
                        ...
                        priority
                    />
                    <h1 className="mt-5 text-3xl md:text-4xl font-bold leading-tight tracking-tight">Strict Liability Traffic System</h1>
                    <p className="mt-4 text-base font-light text-slate-300">Enter the code we sent to your email to continue.</p>
                </div>
            </div>
            ...
            <div className="w-full md:w-1/2 min-h-162.5 flex items-center justify-center p-8 md:p-12">
                <div className="w-full max-w-md">
                    <div className="mb-8 flex flex-col items-center text-center">
                        ...
                        <h2 className="text-3xl font-bold text-[#02073d] dark:text-white mb-1">Check Your Email</h2>
                    ...
                    <div className="mb-6">
                        <label htmlFor="otp" className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Reset Code</label>
                    ...
                    <button onClick={handleVerify} disabled={loading} className={`${primaryBtn} mb-3`}>
                        {loading
...
export default function VerifyForgotPasswordPage() {
    return <Suspense><VerifyForgotPasswordContent /></Suspense>
}